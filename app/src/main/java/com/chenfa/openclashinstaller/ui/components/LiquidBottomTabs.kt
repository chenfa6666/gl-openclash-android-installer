 ...
 * 悬浮液态玻璃底栏（长按拖拽水波动画版）。
 *
 * 移植自 Kyant0/AndroidLiquidGlass catalog 的 LiquidBottomTabs，使用 backdrop 2.0.x 完整 API：
 * - lens 透镜畸变 + vibrancy + blur 做液态玻璃质感
 * - 选中滑块可长按拖拽在 tab 间滑动，松手自动吸附到最近的 tab
 * - 滑块按压时放大、拖拽时根据速度做挤压形变（水波感）
 * - rememberCombinedBackdrop 让滑块透出底栏的品牌色着色层
 * - 触摸位置有 RuntimeShader 径向高光跟随
 */
@Composable
fun LiquidBottomTabs(
    ...
    BoxWithConstraints(modifier, contentAlignment = Alignment.CenterStart) {
        ...
        // ── 不可见着色层（品牌色胶囊，供滑块透过 rememberCombinedBackdrop 采样） ──
