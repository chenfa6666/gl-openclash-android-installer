...
/**
 * 设置对话框：3 个下载 URL + 4 个连接字段（IP/用户/密码/端口），液态玻璃版。
...
fun SettingsDialog(
    ...
    GlassDialog(
        ...
        Column(
            ...
            Text("下载地址", style = MaterialTheme.typography.titleLarge, color = tokens.onGlass)
            OutlinedTextField(
            ...
            Text("路由器连接", style = MaterialTheme.typography.titleLarge, color = tokens.onGlass)
            OutlinedTextField(
